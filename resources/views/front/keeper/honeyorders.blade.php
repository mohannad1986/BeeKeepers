        ...
        <div class="card-body">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><img src="{{URL::asset('assets/dash/img/avatar')}}/{{$order->honyDealer->prof_pic}}" alt="..."
							class="rounded-circle screen-user-profile"  width="40px" height="40px"></td>
                        <td>{{$order->honyDealer->name}}</td>
                        <td>{{$order->honyDealer->email}}</td>
                        @php
                    ...
                    @endphp
                        ...
                        <div class="c-grey text-center col-6 ">
                            <a href="{{url('accept_order')}}/{{$order->id}}"><button type="button"  class="btn main f-warning btn-block fnt-xxl ">قبول</button></a>
                        </div>
                        <div class="c-grey text-center col-6 ">
...
<div class="modal-dialog " role="document">
    <div class="modal-content card shade">
        ...
        <div class="modal-body">
           {{-- ************************************************* --}}
           <form id='offerForm' method="post" action="{{route('refuse_order')}}" style="direction: rtl;">
            @csrf
