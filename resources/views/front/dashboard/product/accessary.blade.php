...
<div class="row">
    ...
    <div class="col-sm-6 col-md-4 col-lg-4">
      <div class="thumbnail text-center" >
        ...
        <img src="{{URL::asset('assets/dash/img/accessory/')}}/{{ $product->p_photo}}" alt="..."  height="200px" width="200px" >
        <div class="caption">
    ...
    <div class="modal-dialog " role="document">
        <div class="modal-content card shade">
            ...
            <div class="modal-body">
               {{-- ************************************************* --}}
               <form id='offerForm' method="post" action="{{route('update_accesso')}}" style="direction: rtl;">
                @csrf
...
{{-- ****** بداية مودل اضافة  منتج ****** --}}
    ...
    <div class="modal-dialog " role="document">
        <div class="modal-content card shade">
            ...
            <div class="modal-body">
               <form id='offerForm' method="post" action="{{route('create_accesso')}}" style="direction: rtl;" enctype="multipart/form-data">
                @csrf
                {{csrf_field()}}
...
<div class="modal-dialog " role="document">
    <div class="modal-content card shade">
        ...
        <div class="modal-body">
           <form id='offerForm' method="post" action="{{route('destroy_accesso')}}" style="direction: rtl;">
            @csrf
